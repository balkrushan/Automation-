...
//		 email.sendKeys("siraskarshyam01@gmail.com");
//		 WebElement pass= driver.findElement(By.xpath("//input[@id='password']"));
//		 pass.sendKeys("krushn@123");
//		 WebElement login= driver.findElement(By.xpath("//button[@id='logIn']"));
//		 login.click();
//		 
//		 WebElement analyst= driver.findElement(By.xpath("(//span[text()='Analyst'])[1]"));
//		 
//		 
//		 
//		 Actions tr=new Actions(driver);
//		 tr.moveToElement(analyst);
//		 tr.perform();
//		 
...
//////////////////////////////copy
//System.setProperty("webdriver.chrome.driver","C:\\Users\\DELL\\Downloads\\chromedriver_win32 (7)\\chromedriver.exe");
//WebDriver driver=new ChromeDriver();
